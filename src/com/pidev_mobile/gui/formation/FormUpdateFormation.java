 ...
 * @author ASUS
 */
public class FormUpdateFormation extends Form{

    public FormUpdateFormation(Formation f,Form previous) {
    ...
    southButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                try {
                    ...
                    Formation F =new Formation(f.getId(),Lebelle.getText(), description.getText(), domaine.getText(), Lieu.getText(), datedeb, datefin, Float.parseFloat(montant.getText()), true, 1, 1, image.getText());
