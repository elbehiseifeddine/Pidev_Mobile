 ...
 */
package pidev_mobile.back.AdminEmploi;
 ...
 * @author seifeddine
 */
public class EmploiStageApprouver  extends BaseForm{
    
    public EmploiStageApprouver(Resources res) {
        super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("blackContainer");
        setTitle("Emploi Stage Approuver");
