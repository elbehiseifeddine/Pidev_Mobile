 ...
 */
package pidev_mobile.back.AdminEvent;
 ...
 * @author seifeddine
 */
public class EventFormApprouver extends BaseForm{
    
    public EventFormApprouver(Resources res) {
        super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("blackContainer");
        setTitle("Event/Form Approuver");
