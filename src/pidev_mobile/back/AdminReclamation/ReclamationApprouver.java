 ...
 * @author seifeddine
 */
public class ReclamationApprouver extends BaseForm{
        private ArrayList<Reclamation> list;

    public ReclamationApprouver(Resources res) {
        super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("blackContainer");
        setTitle("Reclamation Approuver");
...
//         addAll(justatext,AddAdmin);
        ...
        if (list.isEmpty()) {
            Label erreur = createForFont(largeBoldSystemFont, "Vous n'avez approuvé aucune réclamation !!");
