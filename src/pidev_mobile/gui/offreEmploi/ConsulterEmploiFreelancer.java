...
import pidev_mobile.gui.reclamation.AjouterReclamation;
...
public class ConsulterEmploiFreelancer extends BaseForm {
    ...
    public Container addpartholder(offreEmploi f,Resources res) {
        ...
        Button reclam = new Button("Reclamation");
        ...
        reclam.addActionListener(e -> {
            System.out.println("aaaaaaaaaaaaaaaaaaaaaa");
            new AjouterReclamation(res,"Emploi").show();
            
        });
        
        holder.addAll(lbnom, lbcompetences, lbdesc, lbdomaine, lbsalaire, lbdevise, ldateC, ldateE, demande,reclam);
