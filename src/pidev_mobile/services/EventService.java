...
public class EventService {
    ...
    public EventService() {
      ...
      public boolean addEvent(EventLoisir F,String type,int idu){
         ...
         String url=BASE_URL+"/addEventMobile/?labelle="+F.getLabelle()+"&description="+F.getDescription()+"&domaine="+F.getDomaine()+"&lieu="+message+
        ...
        ArrayList<EventLoisir> Events=new ArrayList<>();
         try {
            ...
            for(Map<String,Object> obj:List) {
                ...
                F.setNbParticipant((int)Float.parseFloat(obj.get("nb").toString()));
  ...
  public boolean SupprimerEvent(EventLoisir e){
   ...
   public boolean ModifierEvent(EventLoisir F){
       ResultOK=false;
       String message = URLEncoder.encode(F.getLieu());
         String url=BASE_URL+"/updateEventMobile/?id="+F.getId()+"&labelle="+F.getLabelle()+"&description="+F.getDescription()+"&domaine="+F.getDomaine()+"&lieu="+message+
                 "&dated="+F.getDateDebut()+"&datef="+F.getDateFin()+"&nb="+F.getNbParticipant()+/*"/"+F.isEtat()+*/"&lat="+F.getLat()+"&lng="+F.getLng()+"&image="+F.getImageE();
          req.setUrl(url);
            req.setPost(false);
         req.addResponseListener(new ActionListener<NetworkEvent>() {
