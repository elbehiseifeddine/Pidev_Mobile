 ...
 * @author ahmed
 */
public class OffreChart extends AbstractDemoChart{
    /**
    ...
    public Component execute() {
        String[] titles = new String[]{"Offre par mois", "OffreStage par mois"};
        List<double[]> values = new ArrayList<>();
        values.add(StatService.getInstance().getStatOffreEmploi());
        values.add(StatService.getInstance().getStatOffreStage());
